...
class. If your class is named `com.example.Csdn14Test`, `GenericXmlContextLoader` loads your
application context from `"classpath:com/example/Csdn14Test-context.xml"`. The following
...
----
	...
	// "classpath:com/example/Csdn14Test-context.xml"
...
`com.example.Csdn14Test`, the Groovy context loader loads your application context from
...
if the annotated test class is `com.example.Csdn14Test`, the corresponding default properties
file is `classpath:com/example/Csdn14Test.properties`. If the default cannot be detected, an
...
* Class-level declaration: If the annotated test class is `com.example.Csdn14Test`, the
  corresponding default script is `classpath:com/example/Csdn14Test.sql`.
* Method-level declaration: If the annotated test method is named `testMethod()` and is
  defined in the class `com.example.Csdn14Test`, the corresponding default script is
  `classpath:com/example/Csdn14Test.testMethod.sql`.
